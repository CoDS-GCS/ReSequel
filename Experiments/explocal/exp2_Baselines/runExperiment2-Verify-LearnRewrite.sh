...
rewrite_path="${exp_path}/archive/SIGMOD2026/LearnRewrite/${dbms}/${dataset}-LearnRewrite"
output_path_verify="${exp_path}/archive/SIGMOD2026/LearnRewrite/${dbms}/${dataset}-LearnRewrite-select"
