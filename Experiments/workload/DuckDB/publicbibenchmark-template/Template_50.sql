SELECT pancreactomy22.nppesproviderlastorgname AS nppesproviderlastorgname,
       ...
       AVG(CAST(pancreactomy22.averagemedicareallowedamt AS DOUBLE PRECISION)) AS avgaveragemedicareallowedamtok,
       AVG(CAST(pancreactomy22.averagemedicarepaymentamt AS DOUBLE PRECISION)) AS avgaveragemedicarepaymentamtok,
       AVG(CAST(pancreactomy22.averagesubmittedchrgamt AS DOUBLE PRECISION)) AS avgaveragesubmittedchrgamtok,
...
WHERE ((pancreactomy22.hcpcsdescription IN (N_SSS))
       AND (pancreactomy22.providertype IN (N_SSS)))
