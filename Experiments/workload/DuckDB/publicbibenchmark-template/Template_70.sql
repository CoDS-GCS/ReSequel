SELECT pancreactomy21.nppesproviderlastorgname AS nppesproviderlastorgname,
...
FROM pancreactomy21
WHERE (pancreactomy21.hcpcsdescription = &&&)
GROUP BY pancreactomy21.nppesproviderlastorgname,
