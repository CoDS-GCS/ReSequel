...
AND (mi1.info IN ('Action','Adult','Animation','Comedy','Crime','Documentary','Family','Horror','OFM:35 mm','PFM:35 mm','RAT:1.33 : 1','RAT:1.78 : 1','RAT:1.85 : 1','RAT:2.35 : 1','Short'))
AND (it1.id IN ('3','7','98'))
AND it3.id = '100'
AND it4.id = '101'
