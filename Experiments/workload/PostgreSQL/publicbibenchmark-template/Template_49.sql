SELECT realestate23.calculation222787466264023043 AS calculation222787466264023043,
       ...
       AVG(CAST(CAST(realestate23.price AS BIGINT) AS DOUBLE PRECISION)) AS avgpriceok,
...
WHERE ((realestate23.street ILIKE &&&)
       ...
       AND (realestate23.postcodedistrict = &&&))
GROUP BY realestate23.calculation222787466264023043,
